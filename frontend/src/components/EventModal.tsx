...
import type { EventFlag, TimeLocationFlag, TypeFlag } from '../lib/hday';
import { getEventTypeLabel } from '../lib/hday';
                  ...
                  {typeFlagOptions.map(([flag, label]) => (
                    <Col sm={6} lg={4} key={flag}>
                      <FlagCheckbox
                        ...
                        checked={
                          flag === 'none'
                            ? !eventFlags.some((flagValue) => typeFlagsAsEventFlags.includes(flagValue))
                  ...
                  {timeLocationFlagOptions.map(([flag, label]) => (
                    <Col sm={6} lg={4} key={flag}>
                      <FlagCheckbox
                        ...
                        checked={
                          flag === 'none'
                            ? !eventFlags.some((flagValue) => timeLocationFlagsAsEventFlags.includes(flagValue))
                            : eventFlags.includes(flag)
                        }
