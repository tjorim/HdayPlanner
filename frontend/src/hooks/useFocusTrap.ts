 ...
 *
 * When active, focuses the first focusable child or the container (adding `tabindex="-1"` if needed) and keeps Tab/Shift+Tab navigation contained inside the container.
 *
