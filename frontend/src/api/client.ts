 ...
 * @returns The parsed response body of type `T`. Returns parsed JSON when the response Content-Type includes `application/json`, otherwise returns the response text cast to `T`.
